...
{         
	...
	function login()
	{
		...
		$this->load->view('employee/security/login');
	}
	//======================================================
	function logout()
	{
	...
	function changepwd()
	{
		if($this->input->post('submit'))
		{
			...
			redirect('employee/security/changepwd');
		}
		$this->load->view('employee/header');
		$this->load->view('employee/security/changepwd');
	...
	function forgotPassword()
	{
		if($this->input->post('chk_email'))
		{
...

			{
				...
				$msg ="We have received your forgot password request. if you didn't place any request for password retrive, please ignore this email. and if you realy wants to reset a new password, please &nbsp;<a href='".base_url('security/verification/'.$acc_code)."'>Click here</a>";
			...
			redirect('employee/security/forgotPassword');
