    ...
    <div class="row">
        <div class="col-sm-3 col-md-3 col-lg-2">
            ...
            <ul class="nav nav-pills nav-stacked nav-msg">
                ...
                <li class="active"><a href="<?=base_url('employee/messageboard/trash')?>"><i class="glyphicon glyphicon-trash"></i> Trash</a></li>
            </ul>
        </div>
                   ...
                   <div class="row">
                        ...
                        <div class="btn-group pull-left mt10">
                            ...
                            <ul class="dropdown-menu pull-left" role="menu">
                                <li>
                                    <a href="<?=base_url('employee/messageboard/reply/'.($message["Type"]==0?'inbox':'sentbox').'/'.$this->functions->encode($message['InboxId']))?>">Reply</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('employee/messageboard/forward/'.($message["Type"]==0?'inbox':'sentbox').'/'.$this->functions->encode($message['InboxId']))?>">Forward</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('employee/messageboard/restore/'.($message["Type"]==0?'inbox':'sentbox').'/'.$this->functions->encode($message['InboxId']))?>">Restore</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('employee/messageboard/delete/'.($message["Type"]==0?'inbox':'sentbox').'/'.$this->functions->encode($message['InboxId']))?>">Delete</a>
                                </li>
                            </ul>
                        </div>
...
{
	window.location='<?=base_url('employee/messageboard/view')?>/'+id+'/'+encoded;
}
