    ...
    <div class="row">
        <div class="col-sm-3 col-md-3 col-lg-2">
            <ul class="nav nav-pills nav-stacked nav-msg">
                ...
                <li><a href="<?=base_url('employee/messageboard/sentbox')?>">
                <i class="glyphicon glyphicon-send"></i> Sent Message</a></li>
                <li><a href="<?=base_url('employee/messageboard/trash')?>">
                <i class="glyphicon glyphicon-trash"></i> Trash</a></li>
            </ul>
        </div>
        <div class="col-sm-9 col-md-9 col-lg-10">
            <form name="frmmodule" id="frmmodule" enctype="multipart/form-data"
            action="<?php echo base_url('employee/messageboard/compose');?>" method="post">
