        ...
        <div class="col-sm-3 col-md-3 col-lg-2">
            ...
            <ul class="nav nav-pills nav-stacked nav-msg">
                ...
                <li <?php if($type=='sentbox') echo 'class="active"';?> >
                    <a href="<?=base_url('employee/messageboard/sentbox')?>">
                    <i class="glyphicon glyphicon-send"></i> Sent Message</a>
                </li>
               	<li <?php if($type=='trash') echo 'class="active"';?> >
                    <a href="<?=base_url('employee/messageboard/trash')?>">
        ...
        <div class="col-sm-9 col-md-9 col-lg-10">
           <div class="msg-header">
            <div class="pull-left">
                ...
                onclick="window.location.href='<?=base_url('employee/messageboard/delete/'.$type.'/'.$encodeid)?>'"
                data-toggle="tooltip" title="Delete">
                <i class="fa fa-times"></i>
                </button>
                             
                <button class="btn btn-white tooltips" type="button"
            	onclick="window.location.href='<?=base_url('employee/messageboard/movetotrash/'.$type.'/'.$encodeid)?>'"  
                data-toggle="tooltip" title="Move to Trash">
                <i class="fa fa-trash-o"></i>
                </button>                        
                <button class="btn btn-white tooltips" type="button"
                 onclick="window.location.href='<?=base_url('employee/messageboard/reply/'.$type.'/'.$encodeid)?>'"  
                ...
                <button class="btn btn-white tooltips" type="button" 
                data-toggle="tooltip" 
                onclick="window.location.href='<?=base_url('employee/messageboard/forward/'.$type.'/'.$encodeid)?>'" 
                title="Forward">
