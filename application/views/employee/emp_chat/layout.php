                    ...
                    <div class="media" style="">
                        <div class="pull-left">
                            ...
                            src="<?php if($user['Avtar']!='') 
                                ...
                                else echo base_url('assets/admin/images/photos/profile.png'); ?>">						</a>
                        </div>
...
$('#UserFilter').keyup(function (e) {
	...
	{
		if($(this).val()!='')
		$('.onlineuser-body').load("<?=base_url('employee/empchat/getuserlist');?>"+"/"+$(this).val());	
		else
		window.location='<?=base_url('employee/empchat');?>';
	}
	else
	{
...
{
	$('.chat-window').load("<?=base_url('employee/empchat/chatwindow');?>"+"/"+userid,function() {
