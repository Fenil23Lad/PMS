            ...
            <div class="panel-body">
                ...
                <div class="row task_info">
                    ...
                    <div class="col-sm-4 col-md-4">
                        ...
                        action="<?php echo base_url('employee/task_manager/save/'.$id);?>">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="list-group">
								...
								<?php if($record['ProjectStatus'] == 1) :?> 
                                        &nbsp;
                                        <?php if($Comment['CommentCreatedBy'] == $this->session->userdata('UserId') && $this->functions->time_diff($Comment['CommentCreatedOn']) < 12)
										{ ?>
                                        |&nbsp; 

                                        <a 

                                        href="<?=base_url('employee/task_manager/edit_comment/'.$id.'/'.$Comment['CommentId'])?>"
                                        ...
                                        <a href="<?=base_url('employee/task_manager/delete_comment/'.$id.'/'.$Comment['CommentId'])?>"
						...
						<div class="row">
                        	 <div class="col-sm-12">
								<div class="list-group">
                                <form id="model_form_comment" method="post"  enctype="multipart/form-data" onsubmit="return validate()"

                            action="<?php echo base_url('employee/task_manager/save_comment/'.$id);?>">

                            <input type="hidden" name="TaskId" value="<?=$record['TaskId']?>" />
                            <input type="hidden" name="action" value="reply" />
                                	<div class="col-sm-7">

                                        <textarea  rows="3" name="CommentText" required="required" placeholder="Write your comment hrere..."

                                        class="form-control"></textarea>
                                   </div>
                                   <div class="col-sm-3">

                                       <input type="file" name="CommentAttachment[]" id="CommentAttachment" class="coverimage" class="form-control" multiple="multiple" />
                                            <br />
