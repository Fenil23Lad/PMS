...
<div class="contentpanel">
    ...
    <?php endif; ?>
    <?php if($this->administration->checkEmpTabAccess("Add Designation")):?>
	<div class="row">
		<div class="col-md-8">
			<form name="frmmodule" id="frmmodule" 
            action="<?php echo base_url('employee/role/role_operation');?>" 
            method="post">
   ...
   <?php endif; ?> 
    <div class="row">
     ...
     <?php if($this->administration->checkEmpTabAccess("Delete Designation")):?>
            <div class="btn-group">
        ...
        <?php if($this->administration->checkEmpTabAccess("Add Designation")):?>   
            <div class="pull-right ml10">
                ...
                href="<?=base_url('employee/role/add')?>" title="Add New Category">
      ...
      <?php if($this->administration->checkEmpTabAccess("Employee Designation")):?>  
    <div class="row">	
		<div class="col-md-8">
                ...
                <table class="table table-primary table-bordered">
                	<thead>
                         <tr>
                          ...
                          <?php if($this->administration->checkEmpTabAccess("Edit Designation")):?>     
                            <th class="table-header-repeat line-left">
                            Action
                            </th>
                            <?php endif; ?>
                        ...
                        <?php else: ?>
                            <?php foreach ($roles as $record): ?>
                                    <tr>
                                        ...
                                        <?php if($this->administration->checkEmpTabAccess("Edit Designation")):?>     
                                        <td>
                                     <a href="<?php echo base_url('employee/role/edit/'.$record['RoleId']);?>"
...
$('#frmmodule').validate({
	...
	rules: {
			RoleName: {
				required: true,
				remote: {
						url: "<?php echo base_url('employee/role/check_role_exists/'.(isset($role['RoleId'])?$role['RoleId']:'0'));?>",
						type: "post",
						data: {
