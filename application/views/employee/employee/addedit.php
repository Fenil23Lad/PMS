            ...
            method="post">
                <div class="panel panel-default">
                  ...
                  <?php if($this->administration->checkEmpTabAccess("Employee Designation")):?>
                            <div class="col-sm-1">
                            	<a href="<?=base_url('employee/role');?>" title="Manage Designation">
				...
				UserName: {
						...
						url: "<?php 
							if(isset($record['UserId']))
								echo base_url('employee/employee/register_user_exists/'.$record['UserId']);
							else
								echo base_url('employee/employee/register_user_exists/0');?>",
							type: "post",
							data: {
