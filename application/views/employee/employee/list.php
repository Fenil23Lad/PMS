...
<div class="media">
        ...
        <div class="media-body">
            <ul class="breadcrumb">
                <li><a href="<?=base_url('employee/employee');?>">
...
<div class="contentpanel">
    ...
    <div class="well mt10">
            <div class="row">
            <form action="<?=base_url('employee/employee/search');?>" method="post">
                <div class="col-sm-10">
                    <input type="text" 
    ...
    <div class="row"> 
    	<div class="col-sm-12" style="margin-left:15px;">
          ...
          <?php if($this->administration->checkEmpTabAccess("Delete User")):?>
                ...
                <?php endif; ?>
              <?php if($this->administration->checkEmpTabAccess("Add User")):?>
                <div class="pull-right ml10">
                    <a class="btn btn-xs btn-primary btn-metro" href="<?php echo base_url('employee/employee/add');?>" 
                    title="Add New Post">
    ...
    action="<?php echo base_url('employee/employee/action');?>">
    <div class="row"> 
    	<div class="col-sm-12">
                ...
                <div class="list-group-item record">
                    <div class="media">
                        <div class="media-body">
                         ...
                         <?php if($this->administration->checkEmpTabAccess("Edit User")):?>                          <a class="btn btn-primary btn-xs btn-metro pull-right"
                                href="<?php echo base_url('employee/employee/edit/'.$this->functions->encode($record['UserId']));?>"
                                title="Edit Thread">
