...
<div class="pageheader">
  <div class="media">
    ...
    <div class="media-body">
      <ul class="breadcrumb">
        <li><a href="<?=base_url('employee/task');?>"> <i class="glyphicon glyphicon-home"></i></a></li>
        <li>Task</li>
      </ul>
      <h4>Task</h4>
    </div>
...
<div class="contentpanel">
  ...
  <div class="well mt10">
    <div class="row">
    <form id="tasksheet" action="<?=base_url('employee/task/search');?>" method="post">
      <div class="col-sm-4">
  ...
  <div class="row">
    <div class="col-sm-12 mb10">
      <?php if($this->administration->checkEmpTabAccess("Add Task")):?>
      <a class="btn btn-primary btn-metro mr10" title="Add New Task"             href="<?=base_url('employee/task/add')?>"> <span class="fa fa-plus"></span>&nbsp;            Add New Task </a>
      <?php endif;?>
        ...
        <table class="table table-primary table-bordered table-striped table-condensed cf">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td data-title="Action"><?php if($this->administration->checkEmpTabAccess("Edit Task")):?>
                <?php if($rolename['RoleName'] != 'Team Leader') { ?>
                <a class="btn-link"                                href="<?php echo base_url('employee/task/edit/'.$this->functions->encode($record['TaskId']));?>" title="Edit Task"> <span class="fa fa-edit"></span>&nbsp;Edit </a> &nbsp;|&nbsp;
                <?php } 								else if($record['TaskAssignedBy'] == $this->session->userdata('UserId')) { ?>
                <a class="btn-link"                                href="<?php echo base_url('employee/task/edit/'.$this->functions->encode($record['TaskId']));?>" title="Edit Task"> <span class="fa fa-edit"></span>&nbsp;Edit </a> &nbsp;|&nbsp;
                <?php } ?>
                <?php endif;?>
                
                <?php if($this->administration->checkEmpTabAccess("Delete Task")):?>
                <?php if($rolename['RoleName'] != 'Team Leader') { ?>
                <a class="btn-link"                                onclick="return confirm('Are you sure to Delete ?')"                                href="<?php echo base_url('employee/task/delete/'.$this->functions->encode($record['TaskId']));?>" title="Delete Task"> <span class="fa fa-trash-o"></span>&nbsp;Delete </a> &nbsp;|&nbsp;
                <?php } 								else if($record['TaskAssignedBy'] == $this->session->userdata('UserId')) { ?>
                <a class="btn-link"                                onclick="return confirm('Are you sure to Delete ?')"                                href="<?php echo base_url('employee/task/delete/'.$this->functions->encode($record['TaskId']));?>" title="Delete Task"> <span class="fa fa-trash-o"></span>&nbsp;Delete </a> &nbsp;|&nbsp;
                <?php } ?>
                <?php endif;?>
                
                <a class="btn-link"                                href="<?php echo base_url('employee/task_manager/details/'.$this->functions->encode($record['TaskId']));?>" title="Task Details"> <span class="fa fa-search"></span>&nbsp;Details </a></td>
            </tr>
            <?php endforeach;?>
          </tbody>
        </table>
