    ...
    <div class="row">
        <div class="col-sm-3 col-md-3 col-lg-2">
            ...
            <ul class="nav nav-pills nav-stacked nav-msg">
                ...
                <li class="active">
                <a href="<?=base_url('admin/messageboard/sentbox')?>"><i class="glyphicon glyphicon-send"></i> Sent Message</a></li>
                   ...
                   <div class="row">
                        ...
                        <div class="btn-group pull-left mt10">
                            ...
                            <ul class="dropdown-menu pull-left" role="menu">
                                <li>
                                    <a href="<?=base_url('admin/messageboard/reply/sentbox/'.$this->functions->encode($message['SentboxId']))?>">Reply</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('admin/messageboard/forward/sentbox/'.$this->functions->encode($message['SentboxId']))?>">Forward</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('admin/messageboard/movetotrash/sentbox/'.$this->functions->encode($message['SentboxId']))?>">Move to Trash</a>
                                </li>
                            </ul>
                        </div>
...
{
	window.location='<?=base_url('admin/messageboard/view/sentbox')?>/'+encoded;
}
