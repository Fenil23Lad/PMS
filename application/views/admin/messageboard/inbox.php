    ...
    <div class="row">
        <div class="col-sm-3 col-md-3 col-lg-2">
            ...
            <ul class="nav nav-pills nav-stacked nav-msg">
                ...
                <li><a href="<?=base_url('admin/messageboard/trash')?>"><i class="glyphicon glyphicon-trash"></i> Trash</a></li>
            </ul>
        </div>
                   ...
                   <div class="row">
                        ...
                        <div class="btn-group pull-left mt10">
                            ...
                            <ul class="dropdown-menu pull-left" role="menu">
                                <li>
           <a href="<?=base_url('admin/messageboard/markunread/'.$this->functions->encode($message['InboxId']))?>">Mark as Unread</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('admin/messageboard/reply/inbox/'.$this->functions->encode($message['InboxId']))?>">Reply</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('admin/messageboard/forward/inbox/'.$this->functions->encode($message['InboxId']))?>">Forward</a>
                                </li>
                                <li>
                                    <a href="<?=base_url('admin/messageboard/movetotrash/inbox/'.$this->functions->encode($message['InboxId']))?>">Move to Trash</a>
                                </li>
                            </ul>
                        </div>
...
function readnew(id,encoded)
{
	...
	{
		$.get( "<?=base_url('admin/messageboard/read_new');?>"+"/"+id, function( data ){
			$('li#'+id).removeClass('new');
			window.location='<?=base_url('admin/messageboard/view/inbox')?>/'+encoded;
		});
	}
	else
	{
