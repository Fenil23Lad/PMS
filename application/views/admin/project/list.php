...
<div class="contentpanel">
    ...
    <div class="well mt10">
            ...
            <form action="<?=base_url('admin/project/search');?>" method="post">
    	...
    	<div class="col-sm-12" style="margin-left:15px;">
            ...
            <div class="pull-left sellect_all">                   
                ...
                <div class="pull-right ml10">
                    ...
                    <a class="btn btn-xs btn-primary btn-metro" href="<?php echo base_url('admin/project/add');?>" 
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h4 class="media-heading" style="margin-bottom:5px;">
                                ...
                                <a href="<?=base_url('admin/home/projectDetail/'.$record['ProjectId'])?>">
                                ...
                                href="<?php echo base_url('admin/project/Inactive/'.$this->functions->encode($record['ProjectId']).'/Active');?>"
                                ...
                                href="<?php echo base_url('admin/project/Inactive/'.$this->functions->encode($record['ProjectId']).'/DeActive');?>"
                                ...
                                href="<?php echo base_url('admin/project/edit/'.$this->functions->encode($record['ProjectId']));?>"
                            ...
                            <div class="media-content ml25 top-line">
