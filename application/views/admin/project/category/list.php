...
<div class="contentpanel">
	...
	<div class="row">
		<div class="col-md-8">
            ...
            action="<?php echo base_url('admin/project_category/category_operation');?>" 
            method="post">
    ...
    <div class="row">
    	<div class="pull-left ml10">
            ...
            <div class="pull-right ml10">
                ...
                href="<?=base_url('admin/project_category/add')?>" title="Add New Category">
                            ...
                            <?php foreach ($categories as $record): ?>
                                    <tr>
                                        <td align="center" valign="middle">
                                            ...
                                            value="<?php echo $record['ProjectCategoryId']?>">
                                        </td>
                                        <td>
                                        	&nbsp;<?php echo $record['ProjectCategoryName'];?>
                                        </td>
                                        <td>
                                        	<?php
                                        ...
                                        <td>
                                     <a href="<?php echo base_url('admin/project_category/edit/'.$record['ProjectCategoryId']);?>"
...
$('#frmmodule').validate({
	...
	rules: {
			ProjectCategoryName: {
				required: true,
				remote: {
						url: "<?php echo base_url('admin/project_category/check_category_exists/'.(isset($category['ProjectCategoryId'])?$category['ProjectCategoryId']:'0'));?>",
						type: "post",
						data: {
