		...
		<div class="col-md-8">
            ...
            method="post">
                <div class="panel panel-default">
                   ...
                   value="<?=isset($record['StartDate'])?$record['StartDate']:'';?>" 
                                class="form-control" id="startdatepicker">
                           </div>
                        </div>
                        <!---------------form-group---------------------> 
                        <div class="form-group">
                   ...
                   value="<?=isset($record['FinishDate'])?$record['FinishDate']:'';?>" 
                                class="form-control" id="finishdatepicker">
                           </div>
                        </div>
                        <!---------------form-group---------------------> 
                        <div class="form-group">
