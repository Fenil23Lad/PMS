...
<div class="contentpanel">
	...
	<div class="row">
		<div class="col-md-8">
            ...
            action="<?php echo base_url('admin/industry/role_operation');?>" 
            method="post">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <!---------------form-group--------------------->
                        <input type="hidden" name="IndustryId" 
                        value="<?=isset($indist['IndustryId'])?$indist['IndustryId']:'0';?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?=isset($indist['Name'])?$indist['Name']:'';?>" 
                                class="form-control">
                           </div>
                        </div>
                        <!---------------form-Buttons--------------------->
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="ckbox ckbox-success">
                                    ...
                                    <?php if(isset($indist['Status']))
								 	if($indist['Status']==1){echo 'checked="checked"';}?>
                                    id="Status"/>
    ...
    <div class="row">
    	<div class="pull-left ml10">
            ...
            <div class="pull-right ml10">
                ...
                href="<?=base_url('admin/industry/add')?>" title="Add New Category">
                <i class="glyphicon glyphicon-plus"></i>&nbsp;Add Industry
                </a>
            </div> 
        </div>
    </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($indistry as $record): ?>
                                    <tr>
                                        ...
                                        <td>
                                     <a href="<?php echo base_url('admin/industry/edit/'.$record['IndustryId']);?>"
...
$('#frmmodule').validate({
	...
	rules: {
			Name: {
				required: true,
				remote: {
						url: "<?php echo base_url('admin/industry/check_role_exists/'.(isset($indist['IndustryId'])?$indist['IndustryId']:'0'));?>",
						type: "post",
						data: {
	...
	messages: {
			Name: {
					required: "Please Provide Industry Name.",
					remote: "Industry is already exist, please choose diffrent"
			}
	}
});
//===================================================================================
