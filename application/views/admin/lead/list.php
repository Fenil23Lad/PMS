...
<div class="contentpanel">
    ...
    <div class="well mt10">
            <div class="row">
            <form action="<?=base_url('admin/lead/search');?>" method="post">
                <div class="col-sm-10">
                    <input type="text" 
    	...
    	<div class="col-sm-12">
            <div class="pull-left sellect_all">                                 
                ...
                <div class="pull-right ml10">
                    ...
                    href="<?php echo base_url('admin/lead/summary');?>" 
                ...
                <div class="pull-right ml10">
                    <a class="btn btn-xs btn-primary btn-metro" 
                    href="<?php echo base_url('admin/lead/add');?>" 
                    title="Create New Lead">
                                    ...
                                    <tr>
                                       ...
                                       <td data-title="Source">
                                        ...
                                        <td data-title="Action" >
											<a class="btn-link"
                                                href="<?php echo base_url('admin/lead/edit/'.$this->functions->encode($record['Id']));?>" title="Edit User">
...
function save_note()
{
	...
	$.post('<?=base_url('admin/lead/save_note')?>',
	...
	function(data){
		if(data==1)
		{
			...
			$.get('<?=base_url('admin/lead/get_notes')?>/'+$('input[name=leadId]').val(),
			function(data){
...
function model_open(id,name,org)
{
	...
	$.get('<?=base_url('admin/lead/get_notes')?>/'+id,function(data){
		$('tbody#note_list').html(data);
	});
}
//==============================================================================
